...
void setup() {
  size(1280, 720); //size should be multiple of img width and height. P2D causes glitches.
  smooth();
  frameRate(7);
  ...
  for (int gridX = 0; gridX < img.width; gridX++) {
    for (int gridY = 0; gridY < img.height; gridY++) {
      ...
      case 2:
        ...
        break;
      case 3:// works best with image() function and void movieEvent() function together.
